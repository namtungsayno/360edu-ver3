...
export default function User() {
  const users = [
    { id: 1, name: "Nguyễn Văn A", email: "nguyenvana@email.com", role: "Học viên", status: "Hoạt động" },
    { id: 2, name: "Trần Thị B", email: "tranthib@email.com", role: "Giảng viên", status: "Hoạt động" },
    { id: 3, name: "Lê Văn C", email: "levanc@email.com", role: "Học viên", status: "Tạm khóa" },
  ];
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-400">Danh sách tất cả người dùng trong hệ thống</p>
      </div>

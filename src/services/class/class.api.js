...
export const classApi = {
   ...
   * @param {Object} params - { search, status, isOnline, teacherUserId, minPrice, maxPrice, page, size, sortBy, order }
  ...
  listPaginated: (params = {}) => {
    ...
    if (minPrice !== null && minPrice > 0) queryParams.minPrice = minPrice;
